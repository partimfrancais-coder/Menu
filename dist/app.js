...
function render(){
 ...
 <section class="design-prompt-bar"><div><strong>Menu design prompt</strong><span>Instructions for future menu generation · Saved separately for each restaurant</span></div>${button('design-prompt','Edit design prompt','','secondary')}</section>
