"""Resolve the separate Rooftop drinks restaurant from a current full export."""
import argparse
import copy
import json
from pathlib import Path

RESTAURANT_ID = 'e5ca8e2c-519c-40d8-86be-1727820c3d47'
RESTAURANT_NAME = 'KOI Rooftop Drinks and Cocktail'
...
def prepare(data):
    ...
    if RESTAURANT_ID not in restaurants:
        raise ValueError('The Rooftop Drinks and Cocktail restaurant ID is missing. Verify the target before adapting this helper.')
