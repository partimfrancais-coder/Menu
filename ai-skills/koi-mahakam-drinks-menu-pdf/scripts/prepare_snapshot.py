"""Resolve the separate Mahakam drinks restaurant from a current full export."""
import argparse
import copy
import json
from pathlib import Path

RESTAURANT_ID = '99b9b1b3-6731-4b93-971d-10a1c4e990a4'
RESTAURANT_NAME = 'KOI Mahakam Drinks and Cocktail'
...
def prepare(data):
    ...
    if RESTAURANT_ID not in restaurants:
        raise ValueError('The Mahakam Drinks and Cocktail restaurant ID is missing. Verify the target before adapting this helper.')
